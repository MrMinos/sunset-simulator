...
function animate() {
        ...
        if (useGenericInput) {
                ...
                if (keyboard.pressed('j') && !keyboard.pressed('k') && pathTracingUniforms.uSunDiameter.value > 0.0001) {
                        pathTracingUniforms.uSunDiameter.value -= 0.0001;
                }
                if (keyboard.pressed('k') && !keyboard.pressed('j')) {
                        pathTracingUniforms.uSunDiameter.value += 0.0001;
                }
                if (keyboard.pressed('u') && !keyboard.pressed('i')) {
                        pathTracingUniforms.uNoSun.value = true;
                }
                if (!keyboard.pressed('u') && keyboard.pressed('i')) {
                        pathTracingUniforms.uNoSun.value = false;
                }
                if (keyboard.pressed('n') && !keyboard.pressed('b')) {
                        freeze = true;
                }
